...
content = re.sub(r'<meta name="description" content=".*?" />', '<meta name="description" content="78% of Southern Ontario businesses have employees feeding confidential data into unauthorized AI models. Here\'s what we found in 20 Shadow AI audits." />', content)
content = re.sub(r'<meta name="keywords" content=".*?" />', '<meta name="keywords" content="shadow AI audit, AI governance Ontario, ChatGPT compliance, unauthorized AI use, PIPEDA AI breach" />', content)

# 2. Update Open Graph Data
content = re.sub(r'<meta property="og:title" content=".*?" />', '<meta property="og:title" content="What We Found Hiding in 20 Southern Ontario Shadow AI Audits" />', content)
content = re.sub(r'<meta property="og:description" content=".*?" />', '<meta property="og:description" content="78% of businesses have employees feeding confidential data into unauthorized AI models. Read the report." />', content)
...
# Replacing the bullet points
content = content.replace(
    '<ul>',
    '<ul>\n<li><strong>78%</strong> of employees admitted to using public AI tools for work tasks without management approval.</li>'
)
content = content.replace(<li><strong>No dedicated IT support.</strong> Support meant calling a local computer shop only when something was fatally broken.</li>, "")
content = content.replace(<li><strong>Missing or unverified backups.</strong> 60% believed they had backups, but 80% of those could not successfully verify a recent restore point. Microsoft 365 data was almost never backed up locally.</li>, "")
content = content.replace(<li><strong>Security theater.</strong> Consumer-grade antivirus software running on expired licenses. Multi-factor authentication (MFA) turned off. Global admin credentials shared among multiple staff members.</li>, "")
