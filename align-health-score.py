...
def apply_fixes(file_path):
    try:
        ...
        # CHANGE 6
        content = re.sub(
            r'<li>Unlimited helpdesk support — call, email, or chat</li>\s*<li>Microsoft 365 &amp; Google Workspace management</li>\s*<li>Automated backups &amp; disaster recovery</li>\s*<li>Proactive monitoring — we catch problems before you do</li>\s*<li>Cybersecurity essentials included</li>\s*<li>A real person who knows your business</li>',
        ...
        content = content.replace(
            '<li>AI Acceptable Use Policy</li>\n            <li>Shadow AI Audit</li>\n            <li>M365 Copilot Audit</li>\n            <li>Employee Training</li>',
            '<li>AI Acceptable Use Policy — created and maintained</li>\n <li>Shadow AI audit — quarterly</li>\n <li>M365 AI configuration</li>\n <li>Insurer-ready compliance report</li>\n <li>Cancel anytime</li>'
        )
        ...
        content = content.replace(
            '<li>Everything in Compliance</li>\n            <li>1 Custom Automation Build /mo</li>\n            <li>Private LLM Deployment</li>\n            <li>Priority Helpdesk</li>',
            '<li>Up to 3 active automations maintained</li>\n <li>1 new automation build per quarter</li>\n <li>Monthly AI usage report</li>\n <li>Dedicated account manager</li>'
        )
...
apply_fixes("/data/msp-site/ai-exposure-score.html")
