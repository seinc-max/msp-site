...
file_path = "/data/msp-site/ai-governance-hamilton.html"

changes = [
    (
        "AI Governance for Hamilton",
        "AI Governance & Automation for Professional Services Businesses in Hamilton"
    ),
    (
        "Trueline IT gives your Hamilton business a documented AI policy, safe tools, and verifiable compliance — for a flat monthly fee.",
        "Trueline IT gives your Hamilton business a documented AI policy, safe tools, and ongoing compliance management — for a flat monthly fee."
    ),
    (
    ...
    (
        '<div class="offer-badge">For Hamilton</div>',
...
for i, (old_text, new_text) in enumerate(changes, 1):
    if old_text in content:
        # For item 4, we might replace multiple instances. Limit it to one replacement or replace all, doesn't matter much.
        if i == 4 and content.count(old_text) > 1:
