...
changes = [
    (
        "AI Governance for Guelph",
        "AI Governance & Automation for Professional Services Businesses in Guelph"
    ),
    (
        "Trueline IT gives your Guelph business a documented AI policy, safe tools, and verifiable compliance — for a flat monthly fee.",
        "Trueline IT gives your Guelph business a documented AI policy, safe tools, and ongoing compliance management — for a flat monthly fee."
    ),
    (
    ...
    (
        '<div class="offer-badge">The Trueline Plan</div>',
