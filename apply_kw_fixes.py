...
changes = [
    ...
    (
        "Trueline IT gives your Kitchener-Waterloo business a documented AI policy, safe tools, and verifiable compliance — for a flat monthly fee.",
        "Trueline IT gives your Kitchener-Waterloo business a documented AI policy, safe tools, and ongoing compliance management — for a flat monthly fee."
    ),
    (
